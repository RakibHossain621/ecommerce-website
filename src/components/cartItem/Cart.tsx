        ...
        <div className="lg:flex  p-6">
          ...
          <div className="w-full lg:w-1/3 lg:ml-10 mt-6 md:mt-0">
            <div className="bg-[#FAF3EA] px-20 pt-7 pb-14 rounded-lg">
              <h2 className="font-semibold md:text-[32px] text-[24px] text-black text-center ">Cart Totals</h2>

              <div className="mt-4">
                <div className="md:flex  justify-between ">
                  <span className="text-[16px] font-medium flex md:flex-none text-black">Subtotal</span>
                ...
                <div className="md:flex justify-between mt-3 ">
                  <span className="text-[16px] font-medium flex md:flex-none text-black">Total</span>
