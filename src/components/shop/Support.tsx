...
import { roomData } from '../../seaction/Page'; // Ensure the path is correct

const Support = () => {
    const { support } = roomData; // Destructure support from roomData
            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    {support.map((item, index) => (
                        <div key={index} className="single-support-item p-4 text-center">
