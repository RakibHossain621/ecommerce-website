        ...
        <div className="sec_padding">
           ...
           <div className="wrapper flex">
              <div className="single1 w-[33.33%]">
                ...
                <img className='w-[306px] lg:h-[286px] ml-[112px] mt-[-18em] ' src="/funiro2.png" alt="img2" />
                <img className ='w-[169px] lg:h-[323px] h-[227px] mt-[19px] ' src="/funiro6.png" alt="img6" />
                <img className ='w-[229px] lg:h-[242px] ml-[187px] mt-[-213px] lg:mt-[-329px] ' src="/funiro7.png" alt="img7" />
              </div>
              <div className='single2 w-[33.33%]'>
                <img className='w-[239px] h-[392px] ml-[70px] mt-[154px] ' src="/funiro3.png" alt="img3" />
              </div>
              <div className='single3 w-[33.33%]'>
               <img className='w-[238px] h-[348px] mt-[88px] ml-[-35px] ' src="/funiro4.png" alt="img4" />
               ...
               <img className='w-[183px] h-[196px] ml-[162px] mt-[-241px] ' src="/funiro9.png" alt="img9" />
              </div>
           </div>
        </div>
    );
